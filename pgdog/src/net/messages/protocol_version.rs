...
impl ProtocolVersion {
    ...
    pub(crate) const V3_0: Self = Self::new(3, 0);
    /// PostgreSQL protocol 3.2.
    pub(crate) const V3_2: Self = Self::new(3, 2);
    ...
    pub(crate) fn supports_extended_cancel_key(self) -> bool {
        self >= Self::V3_2
    }
    ...
    pub(crate) fn negotiated(self) -> Option<Self> {
        if self.major != 3 {
            return None;
        }
