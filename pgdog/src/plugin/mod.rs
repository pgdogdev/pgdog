...
pub(crate) static PLUGINS: OnceCell<IndexMap<String, &'static PluginVtable>> = OnceCell::new();
...
pub(crate) fn plugins() -> Option<&'static IndexMap<String, &'static PluginVtable>> {
    PLUGINS.get()
}
