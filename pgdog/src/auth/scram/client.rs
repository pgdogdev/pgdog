...
impl<'a> Client<'a> {
    ...
    pub(crate) fn first(&mut self) -> Result<String, Error> {
    ...
    pub(crate) fn server_first(&mut self, message: &str) -> Result<(), Error> {
    ...
    /// Client last message.
    pub(crate) fn last(&mut self) -> Result<String, Error> {
    ...
    pub(crate) fn server_last(&mut self, message: &str) -> Result<(), Error> {
